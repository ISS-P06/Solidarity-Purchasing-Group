...
const InsertUser = function (props) {
    ...
    const handleSubmit = (values) => {
        ...
        if (values.typeUser === "client") {
            userToAdd.address = values.address;
            userToAdd.balance = values.balance;
        } else if (values.typeUser=== "farmer") {
            userToAdd.address = values.address;
            userToAdd.farmName = values.farmName;
        }
        insertUser(userToAdd)
            .then(() => {
                addMessage({title: "", message: 'Registration is completed with success', type: 'success'});
                if (loggedIn) { //the shop employee registers the user
                    ...
                    <Row className="m-2">
                        <Form.Group as={Col} xs="12" md="6" controlId="mail">
                            ...
                            <Form.Control
                                ...
                                placeholder="mario.rossi@domain.it"
                            />
